...
const ErrorView = ({code, reload}: ErrorViewProps) => {
    return (
        <div className={'notFound middle paddingTop50 paddingBottom50'}>
            <div className={'container marginLeftAuto marginRightAuto paddingLeft15 paddingRight15'}>
                <div className={''}>
                    <svg className="svg404" viewBox="0 0 1000 400">
                        ...
                        <g id="monkey">
                            ...
                            <g id="monkey_arm">
                                ...
                                <g id="armpit">
                                    <path className="st12" d="M165,296c0-4.3-1.8-10.8-6-12c-12.5-3.5-12.4,11.1-12.4,11.1s10.8-1.4,16.7,9.6 C163.3,304.6,165,300.3,165,296z"/>
                ...
                <div className={'text textCenter textDark'}>
                    <h1 className={'margin0 font32 fontNftBlack textCenter'}>
                         Уучлаарай, хуудас олдсонгүй
                    </h1>
                    <p className={'fontNftLight font16 textCenter marginTop15'}>
                        Тухайн хуудасны линк устгагдсан эсвэл солигдсон байж болзошгүй.
                    </p>
                    {
                        reload ? (<button className={'silverBackgroundColor borderRadiusXLarge marginTop15 fontNftMedium font15 paddingBottom15 paddingTop15 paddingLeft30 paddingRight30'}>Дахин холбогдох</button>) : null
                    }
                </div>
            </div>
        </div>
